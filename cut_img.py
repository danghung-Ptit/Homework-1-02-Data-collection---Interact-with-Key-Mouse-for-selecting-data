...
img_counter = 0
image = cv2.imread('/Users/abc/Downloads/imgtest2.jpeg') # đường dẫn ảnh
path = '/Users/abc/Documents/B18DCDT100BSData'				# đường dẫn folder lưu ảnh
oriImage = image.copy()
...
def mouse_crop(event, x, y, flags, param):
	...
	if event == cv2.EVENT_LBUTTONDOWN: # nếu nút chuột trái là xuống, hãy bắt đầu ghi giá toạ độ
		...
		if len(refPoint) == 2:
			...
			img_name = "{}B18DCDT100BS.jpg".format(img_counter) # sửa thành msv của mọi người
